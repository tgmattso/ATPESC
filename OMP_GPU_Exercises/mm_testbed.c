...
void mm_ijk_par (int Ndim, int Mdim, int Pdim, TYPE *A, TYPE *B, TYPE *C);
...
// set matrix dimensions and allocate memory for matrices
   ...
   printf("\n==================================================\n");
   printf(" ijk loop nest, serial case %d %d %d\n", Ndim, Mdim, Pdim);
   mm_tst_cases(NTRIALS, Ndim, Mdim, Pdim, A, B, C, &mm_ijk);

   printf("\n==================================================\n");
   printf(" ijk loop nest, omp CPU (not yet)  %d %d %d\n", Ndim, Mdim, Pdim);
   printf(" OMP MAX NUM THREADS = %d\n",omp_get_max_threads());
   mm_tst_cases(NTRIALS, Ndim, Mdim, Pdim, A, B, C, &mm_ijk_par);

   printf("\n==================================================\n");
   printf(" ijk loop nest, omp GPU (not yet)  %d %d %d\n", Ndim, Mdim, Pdim);
